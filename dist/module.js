...
function (_super) {
  ...
  function ConfigEditor() {
    ...
    _this.onUriChange = function (event) {
      var _a = _this.props,
    ...
    _this.onAPIKeyIdChange = function (event) {
      var _a = _this.props,
          onOptionsChange = _a.onOptionsChange,
          options = _a.options;
    ...
    _this.onAPISecretChange = function (event) {
      var _a = _this.props,
          onOptionsChange = _a.onOptionsChange,
          options = _a.options;
...
function (_super) {
  ...
  function DataSource(instanceSettings) {
    ...
    _this.uri = instanceSettings.jsonData.uri === undefined ? '' : instanceSettings.jsonData.uri;
    _this.apiKeyId = instanceSettings.jsonData.apiKeyId === undefined ? '' : instanceSettings.jsonData.apiKeyId;
    _this.apiSecret = instanceSettings.jsonData.apiSecret === undefined ? '' : instanceSettings.jsonData.apiSecret;
    return _this;
  }
    ...
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        promises = options.targets.map(function (query) {
          return _this.doRequest(query, options).then(function (response) {
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            , Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_1__["getBackendSrv"])().datasourceRequest({
              ...
              data: '{"query":{"queryText":"' + query.queryText + '","evaluatorId": "Cloudtrail"},"arguments":[{"name": "StartTimeRange", "value": "' + options.range.from.toISOString() + '"},{"name": "EndTimeRange", "value": "' + options.range.to.toISOString() + '"}]}',
              headers: {
  ...
  DataSource.prototype.testRequest = function () {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var token, result;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
  ...
  DataSource.prototype.getBearerToken = function () {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var token_result;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
  ...
  DataSource.prototype.testDatasource = function () {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
      var errorMessageBase, result, err_1;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        switch (_a.label) {
          case 0:
            errorMessageBase = 'Data source is not working';
            _a.label = 1;
